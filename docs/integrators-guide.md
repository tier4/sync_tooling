...
It is assumed that the vehicle is using [***REMOVED***][***REMOVED***], is set up using Ansible,
and has access to [Autoware ECU System Setup][autoware-ecu-system-setup] Ansible roles.

[***REMOVED***]: https://github.com/tier4/***REMOVED***
[autoware-ecu-system-setup]: https://github.com/tier4/***REMOVED***
...
Install and configure SYNC.DIAG via the [***REMOVED***.sync_tooling][role-sync-tooling]
...
[role-sync-tooling]: https://github.com/tier4/***REMOVED***/tree/590fabea4f21811a0a69e26793e4fff4f9b60bd1/roles/sync_tooling
